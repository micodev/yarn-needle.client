    ...
    <div class="flex flex-col md:flex-row  p-4 md:p-8 h-full mt-8">
      <div class="w-full md:w-3/4">
        ...
        <Fieldset legend="التقييمات والتعليقات" :toggleable="true" :collapsed="true">
          <div v-for="comment in displayedComments" :key="comment.id" class="mb-4 bg-primary-50 dark:border-2 dark:border-2 dark:border-zinc-700 dark:bg-gray-800 p-2 rounded">
            <div class="flex items-center mb-2">
