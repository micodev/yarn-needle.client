  ...
  <div class="p-8 min-h-screen font-['Tajawal']" dir="rtl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <router-link to="/admin/users" class="no-underline">
        <div class="rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center border-t-4 border-transparent hover:border-indigo-600 dark:bg-gray-800">
