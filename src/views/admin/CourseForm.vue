      ...
      <div class="surface-card p-4 shadow-2 border-round">
        ...
        <div class="grid formgrid">
          ...
          <div class="field col-12 md:col-4">
            ...
            <Select id="categorySelect" v-model="selectedCategories" :options="categoryOptions" optionLabel="name" placeholder="اختر المجالات" display="chip" class="w-full" />
          </div>
          <div class="field col-12 md:col-4">
      ...
      <div class="surface-card p-4 shadow-2 border-round">
        ...
        <div class="grid formgrid">
          ...
          <div class="field col-12 md:col-6">
            ...
            <Select id="subscriptions" v-model="newCourse.subscriptionIncludedNames" :options="subscriptionOptions" optionLabel="label" class="w-full" display="chip" />
          </div>
