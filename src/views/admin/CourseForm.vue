      ...
      <div class="surface-card p-4 shadow-2 border-round">
        ...
        <div class="grid formgrid">
          ...
          <div class="field col-12 md:col-4">
            ...
            <MultiSelect :header="true" id="categorySelect" v-model="selectedCategories" :options="categoryOptions" optionLabel="name" placeholder="اختر المجالات" display="chip" class="w-full" >
              <template #header>
                <div></div>
              </template>
              </MultiSelect>
