      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-8 relative">
        <div v-for="(course) in filteredCourses" :key="course.id"
          ...
          <div class="relative">
            ...
            <div class="absolute inset-0 bg-gradient-to-b from-transparent via-white/[0.5] via-70% to-surface-0 to-70% opacity-100 dark:via-gray-100/[0.2] dark:to-gray-800">
            </div>
