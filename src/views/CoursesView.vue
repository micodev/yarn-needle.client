    ...
    <div class="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
          ...
          <Popover ref="sortPopover" appendTo="body">
            <div class="flex flex-col gap-2">
              ...
              <Button v-if="selectedSort" label="مسح الترتيب" icon="pi pi-times" severity="secondary" text
                class="mt-2 w-full justify-center" @click="selectedSort = null" />
            </div>
          </Popover>
        </div>
      </div>
      ...
      <div v-if="filteredCourses.length > 0"
        ...
        <div v-for="(course) in filteredCourses" :key="course.id"
          class="card p-0 rounded-lg shadow-md relative flex flex-col self-start h-full transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-slate-900">
          <div class="relative">
