          ...
          <div class="absolute top-5 left-4 px-2 w-full">
            ...
            <div class="flex justify-end">
              <span v-if="course.discount"
                class="text-primary font-bold text-center content-center rounded-md px-4 py-1 bg-white bg-opacity-20 backdrop-blur-sm border border-white border-opacity-30 shadow-sm dark:bg-gray-800 dark:bg-opacity-30 dark:border-gray-700">{{
