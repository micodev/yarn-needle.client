          ...
          <div class="absolute top-5 left-4 px-2 w-full">
            ...
            <div class="flex justify-end">
              <span v-if="course.discount"
                class="text-white font-bold text-center content-center rounded-md px-4 py-1 bg-primary bg-opacity-10 backdrop-blur-md border border-primary border-opacity-50 shadow-md dark:bg-primary dark:bg-opacity-30 dark:text-white">{{
