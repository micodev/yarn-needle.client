<template>
  <div
    :class="[
      ...
      IsSpecialMembership ? 'bg-primary-50 dark:bg-gray-800 border-2 border-primary transition-all duration-300 ease-in-out shadow-lg shadow-primary/50 md:hover:scale-110 hover:shadow-xl hover:shadow-primary/50' : 'border-primary-100 border-2 dark:bg-gray-800 md:hover:scale-105 transition-all duration-300 ease-in-out dark:border-2 dark:border-zinc-700'
    ]">
    <div>
