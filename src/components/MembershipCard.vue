<template>
  <div
    :class="[
      ...
      IsSpecialMembership ? 'bg-primary-50 dark:bg-gray-800 border-2 border-primary transition-all duration-300 ease-in-out shadow-lg shadow-primary/50 hover:scale-107 hover:shadow-xl hover:shadow-primary/50' : 'bg-slate-100 dark:bg-gray-800 hover:scale-105 transition-all duration-300 ease-in-out'
    ]">
    <div>
