<template>
  <div class="latest-courses-section py-16 pr-2">
    ...
    <div class="mobile-courses-container pb-4">
      <div class="flex md:flex-wrap md:gap-6 gap-4 relative md:justify-center nowrap">
        ...
        <div v-else v-for="(course) in coursesStore.getRecentCourses" :key="course.title"
          class=" w-4/5 flex-shrink-0 md:flex-shrink md:w-[calc(25%-1rem)] lg:w-[calc(25%-1.5rem)]">
          <CourseCard
            :course="course"
