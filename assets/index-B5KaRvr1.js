...
`)},Z1={root:"p-iconfield"},X1=re.extend({name:"iconfield",theme:q1,classes:Z1}),J1={name:"BaseIconField",extends:_e,style:X1,provide:function(){return{$pcIconField:this,$parentInstance:this}}},Xs={name:"IconField",extends:J1,inheritAttrs:!1};function Q1(e,t,n,i,r,o){return m(),v("div",g({class:e.cx("root")},e.ptmi("root")),[F(e.$slots,"default")],16)}Xs.render=Q1;var ev={root:"p-inputicon"},tv=re.extend({name:"inputicon",classes:ev}),nv={name:"BaseInputIcon",extends:_e,style:tv,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},Js={name:"InputIcon",extends:nv,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function iv(e,t,n,i,r,o){return m(),v("span",g({class:o.containerClass},e.ptmi("root")),[F(e.$slots,"default")],16)}Js.render=iv;var ov=function(t){var n=t.dt;return`
.p-select {
    display: inline-flex;
    cursor: pointer;
    position: relative;
...
`)},Ly={root:"p-inputgroup"},Ty=re.extend({name:"inputgroup",theme:Oy,classes:Ly}),Py={name:"BaseInputGroup",extends:_e,style:Ty,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},ea={name:"InputGroup",extends:Py,inheritAttrs:!1};function $y(e,t,n,i,r,o){return m(),v("div",g({class:e.cx("root")},e.ptmi("root")),[F(e.$slots,"default")],16)}ea.render=$y;var Ey={root:"p-inputgroupaddon"},My=re.extend({name:"inputgroupaddon",classes:Ey}),Dy={name:"BaseInputGroupAddon",extends:_e,style:My,provide:function(){return{$pcInputGroupAddon:this,$parentInstance:this}}},ta={name:"InputGroupAddon",extends:Dy,inheritAttrs:!1};function Fy(e,t,n,i,r,o){return m(),v("div",g({class:e.cx("root")},e.ptmi("root")),[F(e.$slots,"default")],16)}ta.render=Fy;var Ay=function(t){var n=t.dt;return`
.p-menubar {
    display: flex;
    align-items: center;
