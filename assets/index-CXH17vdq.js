...
`)},s2={root:"p-inputgroup"},a2=ue.extend({name:"inputgroup",theme:r2,classes:s2}),l2={name:"BaseInputGroup",extends:Re,style:a2,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},cp={name:"InputGroup",extends:l2,inheritAttrs:!1};function c2(e,t,n,i,r,o){return h(),y("div",g({class:e.cx("root")},e.ptmi("root")),[z(e.$slots,"default")],16)}cp.render=c2;var u2={root:"p-inputgroupaddon"},d2=ue.extend({name:"inputgroupaddon",classes:u2}),f2={name:"BaseInputGroupAddon",extends:Re,style:d2,provide:function(){return{$pcInputGroupAddon:this,$parentInstance:this}}},up={name:"InputGroupAddon",extends:f2,inheritAttrs:!1};function p2(e,t,n,i,r,o){return h(),y("div",g({class:e.cx("root")},e.ptmi("root")),[z(e.$slots,"default")],16)}up.render=p2;var h2=function(t){var n=t.dt;return`
.p-menu {
