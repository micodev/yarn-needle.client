...
`)},ty={root:"p-ink"},ny=de.extend({name:"ripple-directive",theme:ey,classes:ty}),iy=Ce.extend({style:ny});function xo(e){"@babel/helpers - typeof";return xo=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},xo(e)}function oy(e){return ly(e)||ay(e)||sy(e)||ry()}function ry(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
`)},N0={root:"p-tooltip p-component",arrow:"p-tooltip-arrow",text:"p-tooltip-text"},K0=de.extend({name:"tooltip-directive",theme:j0,classes:N0}),H0=Ce.extend({style:K0});function U0(e,t){return G0(e)||Y0(e,t)||q0(e,t)||W0()}function W0(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
